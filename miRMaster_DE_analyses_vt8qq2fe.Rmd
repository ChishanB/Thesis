...
miRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/expression_known_mirnas.csv")
piRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/piRNA_quant.csv")
rRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/rRNA_quant.csv")
snoRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/snoRNA_quant.csv")
tRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/tRNA_quant.csv")
snRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/snRNA_quant.csv")
miscRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/miscRNA_quant.csv")
scaRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/scaRNA_quant.csv")
circRNA <- read.csv("./1_data/miRMaster_raw_formatted/miRMaster_vt8qq2fe/circRNA_quant.csv")
...
```{r, echo=FALSE, message=FALSE}
# Remove the 'precursor' column
miRNA <- miRNA[ ,-1]

# Rename the 'miRNA' column to 'Reference'
colnames(miRNA)[colnames(miRNA) == "miRNA"] <- "Reference"

data <- miRNA

# Define data()# Define thresholds 
min.counts <- 5
min.samples <- 3
...
duplicates <- data$ID[duplicated(data$Reference) | duplicated(data$Reference, fromLast = TRUE)]
print(duplicates)
