...
# Start plotting
# Perform PCA
all_PCA <- prcomp(t(TMM_matrix), center = TRUE, scale. = TRUE)

TE_PCA <- prcomp(t(TMM_TE_matrix), center = TRUE, scale. = TRUE)

gene_PCA <- prcomp(t(TMM_gene_matrix), center = TRUE, scale. = TRUE)
...
level_colors <- c("Acr" = "#cc5500", "Control" = "#0077BB")
...
#ggsave("./2_figures/TE_PCA_oct.png", plot = TE_PCA, width = 8, height = 4, dpi = 300)
...
#ggsave("./2_figures/gene_PCA_oct.png", plot = gene_PCA, width = 8, height = 4, dpi = 300)
...
```{r}
#ggsave("./2_figures/prcomp_TMM_genes_PCA.png", plot = gene_PCA, width = 8, height = 4, dpi = 300)
#ggsave("./2_figures/prcomp_TMM_TEs_PCA.png", plot = TE_PCA, width = 8, height = 4, dpi = 300)
#ggsave("./2_figures/prcomp_TMM_TEsandgenes_PCA.png", plot = TEsandgenes_PCA, width = 8, height = 4, dpi = 300)
```
